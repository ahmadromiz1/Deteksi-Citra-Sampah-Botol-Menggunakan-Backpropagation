...
def filedownload(df):
    ...
    href = f'<a href="data:file/csv;base64,{b64}" download="performance_metrics.img">Download IMG File</a>'
    return href
# ----------------------------------------------------------
...
def get_RGB2(img1):
    ...
    img = io.imread("D:/Pendadaran/Acak/"+img1)[:, :, :]
...
def data0():
    img = loadImages("D:/Pendadaran/Botol//")
...
def data1():
    img = loadImages("D:/Pendadaran/XBotol//")
